...
public class UserInterface {
	...
	public static void updateUser(String firstName, String lastName, String email) throws DataInputException, MalformedURLException, IOException, WebserviceException {
	...
	public static Opdrachtgever createClient(String naam, String voornaam, String bedrijfsnaam, String email, String telefoonnummer) throws DataInputException, JSONException, IOException, WebserviceException {
	...
	public static void updateClient(int index, String naam, String voornaam, String bedrijfsnaam, String email, String telefoonnummer) throws DataInputException, MalformedURLException, IOException, WebserviceException {
	...
	public static Project createProject(String naam, long begindatum, long einddatum, int opdrachtgeverId) throws DataInputException, ParseException, IOException, WebserviceException, JSONException {
	...
	public static void updateProject(int index, String naam, long begindatum, long einddatum, int opdrachtgeverId) throws DataInputException, MalformedURLException, IOException, WebserviceException, ParseException {
	...
	public static Tijdspanne createTimespan(long start, long stop, Taak t, boolean isPause) throws DataInputException, IOException, WebserviceException {
	...
	public static void updateTimespan(int index, long start, long stop, Taak t, boolean isPause) throws DataInputException, IOException, WebserviceException {
	...
	public static void deleteClient(Opdrachtgever c) throws MalformedURLException, IOException, WebserviceException, GUIException {
	...
	public static void deleteProject(Project p) throws MalformedURLException, IOException, WebserviceException {
