...
START TRANSACTION;
USE `chrono_matic`;
INSERT INTO `chrono_matic`.`gebruikers` (`ID`, `naam`, `voornaam`, `gebruikersnaam`, `passwoord`, `email`, `telefoonnummer`, `hash`, `validated`) VALUES (1, 'Possemiers', 'Philippe', 'p', 'p', 'philippe.possemiers@artesis.be', '0903696969', NULL, NULL);
INSERT INTO `chrono_matic`.`gebruikers` (`ID`, `naam`, `voornaam`, `gebruikersnaam`, `passwoord`, `email`, `telefoonnummer`, `hash`, `validated`) VALUES (2, 'Naam1', 'Voornaam1', 'leeg', 'leeg', 'Email1@email.email', '0000000000', NULL, NULL);
