...
START TRANSACTION;
USE `chrono_matic`;
INSERT INTO `chrono_matic`.`gebruikers` (`ID`, `naam`, `voornaam`, `gebruikersnaam`, `passwoord`, `email`, `telefoonnummer`) VALUES (1, 'Possemiers', 'Philippe', 'p', 'p', 'philippe.possemiers@artesis.be', '0903696969');
INSERT INTO `chrono_matic`.`gebruikers` (`ID`, `naam`, `voornaam`, `gebruikersnaam`, `passwoord`, `email`, `telefoonnummer`) VALUES (2, 'Naam1', 'Voornaam1', 'leeg', 'leeg', 'Email1@email.email', '0000000000');
...
START TRANSACTION;
USE `chrono_matic`;
INSERT INTO `chrono_matic`.`taken` (`ID`, `begin_tijd`, `verwacht_eind`, `commentaar`, `voltooid`, `projecten_ID`) VALUES (1, 1349845200, 1355292000, 'Oefening reeks 1', false, 1);
INSERT INTO `chrono_matic`.`taken` (`ID`, `begin_tijd`, `verwacht_eind`, `commentaar`, `voltooid`, `projecten_ID`) VALUES (2, 1349845200, 1349845200, 'Oefening reeks 2', true, 1);
INSERT INTO `chrono_matic`.`taken` (`ID`, `begin_tijd`, `verwacht_eind`, `commentaar`, `voltooid`, `projecten_ID`) VALUES (3, 1349672400, 1349672400, 'Begin app', true, 3);
INSERT INTO `chrono_matic`.`taken` (`ID`, `begin_tijd`, `verwacht_eind`, `commentaar`, `voltooid`, `projecten_ID`) VALUES (4, 1355119200, 1356847200, 'App maken 2', false, 3);
