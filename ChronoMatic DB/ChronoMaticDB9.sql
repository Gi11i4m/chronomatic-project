...
START TRANSACTION;
USE `chrono_matic`;
INSERT INTO `chrono_matic`.`taken` (`ID`, `begin_tijd`, `verwacht_eind`, `commentaar`, `voltooid`, `projecten_ID`) VALUES (1, 1350277200, 1350709200, 'JSP', NULL, 1);
INSERT INTO `chrono_matic`.`taken` (`ID`, `begin_tijd`, `verwacht_eind`, `commentaar`, `voltooid`, `projecten_ID`) VALUES (2, 1352527200, 1353391200, 'array', NULL, 2);
...
START TRANSACTION;
USE `chrono_matic`;
INSERT INTO `chrono_matic`.`tijdspanne` (`ID`, `begin_uur`, `eind_uur`, `pauze`, `taken_ID`) VALUES (1, 1350322200, 1350343800, NULL, 1);
INSERT INTO `chrono_matic`.`tijdspanne` (`ID`, `begin_uur`, `eind_uur`, `pauze`, `taken_ID`) VALUES (2, 1353361500, 1353380725, NULL, 2);
